/* eslint-disable */
// Generated by Wrangler by running `wrangler types --cwd worker --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d70b51ab99ffffbea133295e41759879)
